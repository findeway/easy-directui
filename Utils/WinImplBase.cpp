...
{
    //////////////////////////////////////////////////////////////////////////
#define ID_TIMER_SHOWSHADOW			101
#define TIMER_DELAY_SHADOW			100
    ...
    void WindowImplBase::ShowWindow(bool bShow /*= true*/, bool bTakeFocus /*= true*/)
    {
        ...
        return __super::ShowWindow(bShow, bTakeFocus);
    }
    ...
    {
        if (wParam == ID_TIMER_SHOWSHADOW)
        {
            KillTimer(GetHWND(), ID_TIMER_SHOWSHADOW);
            ShowShadow();
        }
        return 0L;
    }
